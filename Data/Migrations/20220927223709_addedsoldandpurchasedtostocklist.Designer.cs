...
namespace Stock_keeping.Data.Migrations
{
    ...
    [Migration("20220927223709_addedsoldandpurchasedtostocklist")]
    partial class addedsoldandpurchasedtostocklist
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stock_keeping.Models.Branch", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Stock_keeping.Models.SalesReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Stock_keeping.Models.SalesSummary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Stock_keeping.Models.StockList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Stock_keeping.Models.Product", b =>
                {
                    b.HasOne("Stock_keeping.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Stock_keeping.Models.PurchaseList", b =>
                {
                    ...
                    b.HasOne("Stock_keeping.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Stock_keeping.Models.PurchaseReport", b =>
                {
                    ...
                    b.HasOne("Stock_keeping.Models.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("Stock_keeping.Models.SalesReport", b =>
                {
                    b.HasOne("Stock_keeping.Models.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Stock_keeping.Models.ApplicationUser", b =>
                {
                    b.HasOne("Stock_keeping.Models.Branch", "Branch")
                        .WithMany()
